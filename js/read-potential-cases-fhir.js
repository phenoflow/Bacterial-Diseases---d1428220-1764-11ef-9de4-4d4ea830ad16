...
(async () => {
  ...
  await fs.writeFile("bacterial-diseases-potential-cases.csv", "patient-id,dob,codes,last-encounter\n");
  for(let patient in patients) {
    try {
      ...
      await fs.appendFile("bacterial-diseases-potential-cases.csv", row);
    } catch(error) {
      console.log(error);
    }
  }
